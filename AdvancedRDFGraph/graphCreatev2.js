...
var _rdfStoreSetup = function(){
    ...
    /*
    * Setting the prefixes for the RDF
    */
    /*for(p in Object.keys(rdfConfig.prefixes)){
      rstore.rdf.setPrefix(p, rdfConfig.prefixes[p])
      _addToStoreNamespace(p, rdfConfig.prefixes[p])
    }*/
      //console.log("Namespaces:---->", namespaces)
    return {store:rstore, graph:graph}
  }

  var _rdfGraphCreate = function(){
    let graph = store.rdf.createGraph()
    return {graph: graph}
  }


var _setRDFPrefix = function(Obj){
    store.rdf.setPrefix(Object.keys[obj][0], Obj[Object.keys[obj][0]])
    _addToStoreNamespace(Object.keys[obj][0], Obj[Object.keys[obj][0]])
...
module.exports = {
  ...
  rdfGraphCreate : _rdfGraphCreate,
  setRDFPrefix : _setRDFPrefix,
